...
def calculate_rating(immo_data: list[ImmoData]):
    ...
    for immo in immo_data:
        ...
        living_area_adjusted_value = _get_normalized_value(
            immo.living_area, min_living_area, max_living_area
        )
        land_area_adjusted_value = _get_normalized_value(
            immo.land_area, min_land_area, max_land_area
        )
        distance_adjusted_value = _get_normalized_value(
            immo.distance, min_distance, max_distance, inverted=True
        )
